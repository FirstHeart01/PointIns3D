...
class OctreeBallQuery(Function):
    
    @staticmethod
    def forward(ctx, coords, mean_active, radius):
        """
        """
        coords = coords.cpu()
...
octree_ball_query = OctreeBallQuery.apply
...
class BFSCluster(Function):
    ...
    @staticmethod
    def forward(ctx, cluster_numpoint_mean, ball_query_idxs, start_len, threshold, semantic_preds_cpu=None, class_id=None):
        '''
        :param ctx:
        ...
        if class_id != None:
            ...
            ops.bfs_cluster2(semantic_preds_cpu, ball_query_idxs, start_len, cluster_idxs,
