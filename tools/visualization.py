...
SEMANTIC_NAMES = np.array([
    'building', 'low vegetation', 'med. vegetation', 'high vegetation', 'vehicle',
...
CLASS_COLOR = {
    ...
    'med. vegetation':[255, 255, 0], 
    'high vegetation':[255, 0, 255], 
    'vehicle':[100, 100, 255],
    'truck':[200, 200, 100], 
    'aircraft':[170, 120, 200], 
    'militaryVehicle':[255, 0, 0], 
    'bike':[200, 100, 100], 
    'motorcycle':[10, 200, 100], 
    'light pole':[200, 200, 200],
    'street sign':[50, 50, 50],
    'clutter':[60, 130, 60], 
    'fence':[130, 30, 60]
}
